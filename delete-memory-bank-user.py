...
print(f"'{AGENT_ENGINE_ID}' Agent Engine에서 'user'의 기억을 조회하고 삭제합니다.")
    ...
    for memory in memories:
        ...
        try:
            ...
            if memory_name:
                ...
                print(f"✅ 메모리 삭제 완료: {memory_name}")
                deleted_count += 1
            else:
                print("❌ 메모리 이름을 찾을 수 없어 삭제할 수 없습니다.")
        except Exception as delete_error:
            print(f"❌ 메모리 삭제 실패: {delete_error}")
...
if not memory_found:
    ...
    print("====================================")
    print(f"총 {deleted_count}개의 메모리를 삭제했습니다.")
